...
const slides = [
  ...
  },
  {
    ...
    highlight: "0.19 MNT",
    value: "≈ $24.31",
    footer: { network: "Mantle", status: "Normie" },
  ...
  },
  {
    ...
    title: "Top 5\nTransactions",
    items: [
      { id: "2nyh...EYgD", count: 386, val: "0.02 MNT" },
      { id: "D2L6...e7NZ", count: 378, val: "0.02 MNT" },
      { id: "2q5p...fWGJ", count: 369, val: "0.02 MNT" },
      { id: "4ACf...hDEE", count: 366, val: "0.02 MNT" },
      { id: "4vie...N3Ey", count: 361, val: "0.02 MNT" },
    ],
    color: "from-[#0D0B14] to-[#1A1625]",
  },
  {
    ...
    percent: "90%",
    desc: "YOU RANKED TOP 90% IN THE MANTLE HOLDERS GLOBAL PERCENTAGE",
    rankLabel: "RANK DESIGNATION",
    rank: "Mantle Plankton",
  ...
  },
  {
    ...
    stats: [
      ...
      { label: "TOP ASSET", value: "MNT", sub: "$595.735 Value" },
      { label: "GLOBAL RANK", value: "90%", sub: "MANTLE PLANKTON" },
    ],
