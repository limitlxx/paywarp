                    ...
                    <Card className="glass-card border-purple-500/20">
                      ...
                      <CardContent className="space-y-4">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="text-foreground font-bold">$4,100 / $5,000</span>
                        </div>
                        <Slider
                          value={goalAmount}
                          max={10000}
                        ...
                        />
                        {goalAmount[0] >= 5000 && (
                          <div className="p-2 rounded-lg bg-green-500/10 border border-green-500/20 text-green-400 text-[10px] flex items-center gap-1">
                            <Zap className="w-3 h-3 fill-current" />
                            GOAL COMPLETE: +1% BONUS APY UNLOCKED
                          </div>
                        )}
                        <p className="text-xs text-muted-foreground">
                          You are 82% of the way to your target. At current yield rates, you will reach it in 3 months.
                        </p>
                      </CardContent>
                    </Card>
                  )}
